...
Разработать структуру, реализующую дуплексный канал межпроцессного взаимодействия на неименованных каналах (pipe). Использовать при этом отдельные принципы построения программ на C в ООП-стиле (вспомнить обсужденное на 2 семинаре, см. также [примеры](https://github.com/3sem/3sem_2026/tree/main/task_2/examples) и источники [1](https://lwn.net/Articles/444910/) и [2](https://litux.nl/mirror/kerneldevelopment/0672327201/ch12lev1sec4.html)). 
